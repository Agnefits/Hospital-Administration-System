...
namespace Hospital_Administration_System.Migrations
{
    ...
    [Migration("20250509082907_AddPatientConditionMonitoringTable")]
    partial class AddPatientConditionMonitoringTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hospital_Administration_System.Models.PatientConditionMonitoring", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PatientConditionMonitorings");
                });
            ...
            modelBuilder.Entity("Hospital_Administration_System.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Hospital_Administration_System.Models.Admin", b =>
                {
                    b.HasOne("Hospital_Administration_System.Models.User", "User")
                        .WithOne("Admin")
            ...
            modelBuilder.Entity("Hospital_Administration_System.Models.Department", b =>
                {
                    ...
                    b.HasOne("Hospital_Administration_System.Models.User", "HeadDoctor")
                        .WithMany()
            ...
            modelBuilder.Entity("Hospital_Administration_System.Models.PatientConditionMonitoring", b =>
                {
                    b.HasOne("Hospital_Administration_System.Models.Nurse", "Nurse")
                        .WithMany("PatientConditionMonitorings")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Hospital_Administration_System.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Hospital_Administration_System.Models.Nurse", b =>
                {
                    b.Navigation("PatientConditionMonitorings");
                });
